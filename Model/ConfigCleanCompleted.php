...
{
    /** @var string */
    const TRANSPORTER_CLEANER_COMPLETED_IS_ENABLED_CONFIG_PATH = 'crt/cleaner/cleaner_completed_enabled';

    /** @var string */
    const TRANSPORTER_CLEANER_COMPLETED_CRON_EXPRESSION_CONFIG_PATH = 'crt/cleaner/cleaner_completed_cron_expression';

    /** @var string */
    const TRANSPORTER_CLEANER_COMPLETED_HOURS_TO_KEEP_CONFIG_PATH = 'crt/cleaner/cleaner_completed_hours_to_keep';
