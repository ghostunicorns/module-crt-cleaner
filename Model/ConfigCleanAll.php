...
{
    /** @var string */
    const TRANSPORTER_CLEANER_ALL_IS_ENABLED_CONFIG_PATH = 'crt/cleaner/cleaner_all_enabled';

    /** @var string */
    const TRANSPORTER_CLEANER_ALL_CRON_EXPRESSION_CONFIG_PATH = 'crt/cleaner/cleaner_all_cron_expression';

    /** @var string */
    const TRANSPORTER_CLEANER_ALL_HOURS_TO_KEEP_CONFIG_PATH = 'crt/cleaner/cleaner_all_hours_to_keep';
